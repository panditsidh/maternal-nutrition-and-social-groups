...
foreach overvar in parity_bs parity birth_space_cat wealth {
...
replace over_name = "p2, <2yrs"  if over_counter==1 & cat==2
replace over_name = "p2, 2-3yrs"  if over_counter==1 & cat==3
replace over_name = "p2, 3+yrs"  if over_counter==1 & cat==4
replace over_name = "p3, <2yrs"  if over_counter==1 & cat==5
replace over_name = "p3, 2-3yrs"  if over_counter==1 & cat==6
replace over_name = "p3, 3+yrs"  if over_counter==1 & cat==7
replace over_name = "p4+, <2yrs"  if over_counter==1 & cat==8
replace over_name = "p4+, 2-3yrs"  if over_counter==1 & cat==9
replace over_name = "p4+, 3+yrs"  if over_counter==1 & cat==10


replace over_name = "Parity 1"  if over_counter==2 & cat==1
replace over_name = "Parity 2"  if over_counter==2 & cat==2
replace over_name = "Parity 3"  if over_counter==2 & cat==3
replace over_name = "Parity 4+"  if over_counter==2 & cat==4





replace over_name = "Below 2 years"  if over_counter==3 & cat==1
replace over_name = "2-3 years"  if over_counter==3 & cat==2
replace over_name = "Above 3 years"  if over_counter==3 & cat==3
replace over_name = "1st birth"  if over_counter==3 & cat==9

replace over_name = "Quartile 1"  if over_counter==4 & cat==1
replace over_name = "Quartile 2"  if over_counter==4 & cat==2
replace over_name = "Quartile 3"  if over_counter==4 & cat==3
replace over_name = "Quartile 4"  if over_counter==4 & cat==4
