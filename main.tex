...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \adjustbox{width=\textwidth}{\input{tables/kitagawa_3}}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \adjustbox{width=\textwidth}{\input{tables/kitagawa_4}}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \adjustbox{width=\textwidth}{\input{tables/kitagawa_5}}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \adjustbox{width=\textwidth}{\input{tables/kitagawa_2}}
\end{table}
